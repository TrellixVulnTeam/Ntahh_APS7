...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.img = 'https://api-oneebotz.herokuapp.com/images/aOnee.png'
        global.fla = pickRandom(global.flaaa)
        global.namabot = conn.user.name
        global.packname = '❏ One Botz\n\n\n\n\n\n\nwa.me/6282128475388\n\n'
        global.author = ''
        global.packname2 = '❏ One Botz'
        global.author2 = ''
        global.wm3 = '❏ One BotZ˚'
        global.wm2 = '⫹⫺ Onee 𝗕𝗢𝗧'
        global.wm = '「 Onee BOT あ⁩ 」'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'One Botz'
        global.kontak2 = [
        ['6283271710709', 'Davitt', 'Orang', 'Ingin Mabar Tapi Device Ga Mendukung :/', true],
        ['6282128475388', 'Nomor Orang', 'Gatau Gw Yang Ini', 'Hehe', true]
        ]
