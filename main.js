...
async function connectionUpdate(update) {
  ...
  if (connection == 'connecting') console.log(chalk.redBright('🗿 Sabar Bang..'))
  if (connection == 'open') {
      console.log(chalk.green('👍 Okee.. Udah Tersambung...'))
  }
  if (connection == 'close') console.log(chalk.red('🙏 Koneksi Terputus, Menyambungkan Ulang . . .'))
