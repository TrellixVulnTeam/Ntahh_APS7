...
global.owner = [
  ...
  ['0'],
  ['447710173736'],
  ['447578881250', 'Selalu Santai Walau Tugas Membantai', true]
...
global.APIKeys = { // APIKey Here
  ...
  'https://api.xteam.xyz': '7047f08f5a0ea4bcdf55cd72',
...
/*============== WATERMARK ==============*/
global.wm = '『 *_One BotZ_* 』' //Main Watermark
global.wm2 = '\n⬡ One Botz'
global.wm3 = '✓ Farhan Ganz'
global.botdate = `✾ 𝗗𝗮𝘁𝗲: ${week} ${date}\n✾ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `✾ 𝗪𝗵𝗮𝘁𝘀𝗮𝗽𝗽 𝗕𝗼𝘁 𝗠𝘂𝗹𝘁𝗶-𝗗𝗲𝘃𝗶𝗰𝗲`
global.author = '---------------『 Onee 』---------------' 
...
global.thumbdoc = 'https://i.pinimg.com/736x/6d/70/43/6d704359b36e2c9bdde55a98468faa64.jpg'
