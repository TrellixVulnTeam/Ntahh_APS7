                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        let wel = API('hardianto', '/api/welcome3', {
                                ...
                                bg: 'https://uploader-one-botz.herokuapp.com/file/uOfyt5OVhcQd.jpeg',
                            ...
                            let lea = API('hardianto', '/api/goodbye3', {
                                profile: pp,
                                name: await this.getName(user),
                                bg: 'https://uploader-one-botz.herokuapp.com/file/9crLJX5zpXsX.jpg',
                                namegb: await this.getName(id),
                                member: groupMetadata.participants.length
                            })
                            // ----- ENC :v -------
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        owner: 'Anda Bukan Owner Saya :)',
        mods: 'Anda Bukan Moderator Saya :)',
        premium: 'Anda Bukan Pelanggan Premium :)',
        group: 'Gunakan Fitur Ini Di *Grup* :)',
        private: 'Gunakan Fitur Ini Di *Chat Pribadi* :)',
        admin: 'Anda Bukan Admin Grup Ini Ya :),
        botAdmin: 'Jadiin Aku Admin Ganteng/Cantik',
...
sourceUrl: sgc
    ...
    let msgg = {
    	unreg: '*DAFTAR*\nHai, Kamu Belum Kedaftar Ke Database Bot Nih.. Coba Kamu Pencet Tombol Di Bawah Pesan Untuk Melanjutkan/Mendaftar.'
}[type]
if (msgg) return conn.sendButton(m.chat, `${global.htki} REGISTER ${global.htka}`, msgg, null, ['DAFTAR :D', '/verify'],m)
}
