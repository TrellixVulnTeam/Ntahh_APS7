...
│⬡ Ram yg Digunakan : *${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB*
┗──────────⬣
%readmore`.trimStart(), 
  header: '┏━━〔 %category 〕━ꕥ',
  body: '┃❑ %cmd %islimit %isPremium',
  footer: '┗━━━━━━━━ꕥ', 
  footerText: '%week %weton',
  after: `✾ One Botz`,
}
...
const template = generateWAMessageFromContent(m.key.remoteJid, proto.Message.fromObject({
        listMessage: {
            "title": `*${ucapan()}, ${name}*`.trim(),
                        "description": `Onee-BotZ_MD`.trim(),
                        "footerText": "Kalo Ada Yanh Error, Report Ke Owner",
