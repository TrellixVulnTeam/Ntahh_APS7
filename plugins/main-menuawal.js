...
conn.send2ButtonImg(m.chat, await genProfile(conn, m), konten, ᴛᴇs, but1, id1, but2, id2, m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    ...
    mediaType: 2, 
    description: sgc,
    title: "ᴊᴀɢᴀ ᴋᴇꜱᴇʜᴀᴛᴀɴ Yᴀ",
    body: kata,
    thumbnail: fs.readFileSync('./menu-a.jpg'),
    sourceUrl: sgc
     }}
  })
}
...
async function genProfile(conn, m) {
  let font = await jimp.loadFont('./names.fnt'),
    ...
    avatar = await jimp.read(await conn.profilePictureUrl(m.sender, 'image').catch(() => 'https://telegra.ph/file/cee3de57105c6be040df2.jpg')),
