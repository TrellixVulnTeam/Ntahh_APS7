...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	if (!text) throw `uhm.. urlnya mana?\n\npenggunaan:\n${usedPrefix + command} url\ncontoh:\n${usedPrefix + command} https://www.mediafire.com/file/sn9nbvchwxvz56u/WhatsApp+Unclone+by+David+x+Isal`
...
_File Tidak Akan Terkirim Bila Ukuran File Melebihi 120 MB_
`.trim()
