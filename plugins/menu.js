  ...
  try {
    ...
    if (teks == '404') {
      return conn.sendMessage(m.chat, {
           title: `Hai, ${'@'+m.sender.split`@`[0]}`.trim(),
           text: `\nRank : ${rank}\nLimit *${limit}* Limit\nLevel *${level}*`, 
           footer: "😁👋",
           ...
           "sections": [
            {
              "rows": [
                ...
                {
                  "title": "Kerang Ajaib",
                  "description": "Menampilkan Menu Kerang Ajaib",
                  "rowId": ".? kerang"
                }, {
                  "title": "Quotes",
                ...
                {
                  "title": "Premium",
                  "description": "Menampilkan Menu Khusus User Premium",
                  "rowId": ".? premium"
                },
                {
                  "title": "Internet",
                ...
                {
                  "title": "Nulis & Logo",
                  "description": "Menampilkan Menu Nulis & Logo",
                  "rowId": ".? nulis"
                }, {
                  "title": "Downloader",
                ...
                {
                  "title": "Asupan",
                  "description": "Menanpilkan Menu Asupan",
                  "rowId": ".? asupan"
                },
                {
                  "title": "Database",
                  "description": "Menyimpan Sesuatu Di Bot",
                  "rowId": ".? database"
                },
                {
                  "title": "Al-Qur'an",
                ...
                {
                  "title": "Info",
                  "description": "Menampilkan Menu Lainnya",
                  "rowId": ".? info"
                },
                {
                  "title": "Exp",
                  "description": "Menampilkan Menu XP (2)",
                  "rowId": ".? exp"
                },
              ]
            }
