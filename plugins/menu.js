 ...
 *Powered By @${'16199961931'.split('@')[0]}*`
 ...
 const ftroli = {
    ...
    message: `One BotZ-MD`, 
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://api-oneebotz.herokuapp.com/images/aOnee.png')).buffer(), //Gambarnye
    sellerJid: '0@s.whatsapp.net' 
    }
    }
    }
...
Saya One Botz. Bot WhatsApp Yang Di Buat Dari Hasil Begadang David. Kalo Ga Ngerespon Berarti Anda Belum Punya Ayang 🗿`
...
return conn.send2ButtonLoc(m.chat, cute, ori, `Note : If You Use Old Wa Or Mod And Button It Doesn't Look Di Rectly Type ${_p}? all`, 'COMMAND', '.menu2', 'SPEED', '.speed', m)
