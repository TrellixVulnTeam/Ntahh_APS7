...
exports.createExif = (pack, auth) => {
	...
	const exif = {"sticker-pack-id": "com.mobile.legends", "sticker-pack-name": metadata.packname, "sticker-pack-publisher": metadata.author, "android-app-store-link": `https://play.google.com/store/apps/details?id=com.mobile.legends`, "emojis": metadata.categories ? metadata.categories : [""] }
